...
class RectumDataset(tc.utils.data.Dataset):
    def __init__(
        self,
        ...
        for i in range(len(self.dataframe)):
            ...
            gt_1 = current_case['Ground-Truth-Mesorectal']
            gt_2 = current_case['Ground-Truth-Extramural']
            if gt_1 != 0 or gt_2 != 0:
                class_1_counter += 1
            else:
                class_0_counter += 1
    ...
    def __getitem__(self, idx):
        ...
        if self.return_paths:
            return output, features, gt_1, gt_2, spacing, dict(**current_case, **input_metadata)
        else:
            return output, features, gt_1, gt_2, spacing
